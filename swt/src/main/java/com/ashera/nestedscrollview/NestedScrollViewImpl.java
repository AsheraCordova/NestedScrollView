...
return this;}
	...
	private void setEnabled(boolean b) {
		org.eclipse.swt.custom.ScrolledComposite scrolledComposite = (org.eclipse.swt.custom.ScrolledComposite) asNativeWidget();
		scrolledComposite.setEnabled(b);
	}
	...
	private boolean hasReachedEnd(int selection){
		...
		return selection + verticalBar.getThumb() == verticalBar.getMaximum();
	}
}
