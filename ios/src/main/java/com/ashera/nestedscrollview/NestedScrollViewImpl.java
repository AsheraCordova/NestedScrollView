...
return this;}
	...
	class MyUIScrollViewDelegate {
		...
		public MyUIScrollViewDelegate() {
			getFragment().addListener(NestedScrollViewImpl.this, this);
		}
	...
	private void setEnabled(boolean objValue) {
		setScrollEnabled(uiView, objValue);
	}
	
	private native void setScrollEnabled(Object nativeWidget, Object value) /*-[
		((UIScrollView*) nativeWidget).scrollEnabled = [(JavaLangBoolean*) value booleanValue];
	]-*/;
	

	private native boolean hasReachedEnd(int selection) /*-[
